 ...
 * @returns {boolean}
 */
Remove.prototype.setNameSpace = function(namespace) {
 ...
 * @return {boolean}
 */
Remove.prototype.makeModule = function() {
  ...
  // Remove temporary directory in order to mange file parsing
 ...
 * @param {string} source
 */
Remove.prototype.searchReplace = function( dest, source) {
  var that = this;
 ...
 */
Remove.prototype.parseFiles = function(dir) {
 ...
 */
Remove.prototype.generateTempPath = function(file) {
 ...
 */
Remove.prototype.copy = function(from, to, deepCopy, rename) {
  var self = this;
  if (deepCopy) {
 ...
 * @return {boolean}
 */
Remove.prototype.mkdir = function(dir, recursiveSync) {
  var self = this;
  if (recursiveSync) {
    try {
      fs.mkdirpSync(dir);
 ...
 * @return {string}
 */
Remove.prototype.renameFile = function(file, type) {
 ...
 */
Remove.prototype.launch = function() {
  var that = this;
